...
<% 		
	...
	String sql = "select unq, one_title, one_name, one_phone, one_content from cs_oneonone where unq="+unq;
		...
		<%@ include file="../include/n_left_menu.jsp" %>
			...
			<table class="one_table">						
					...
					<tr>
						<th>▶등록인</th>
						<td class="one_td1">
							<input type="text" name="name" id="name" class="one_text" value="<%=name %>">
						</td>
					</tr>
					<tr>
						<th>▶암호</th>
					...
					<tr>
						<th>▶휴대전화</th>
						<td class="one_td1">
							<input type="text" name="phone" id="phone" class="one_text" value="<%=phone %>">
					...
					<tr>
						<th>▶제목</th>
						<td class="one_td1">
							<input type="text" name="title" id="title" class="one_text2" value="<%=title %>">
						</td>
					</tr>
					<tr>
						<td colspan="2" class="one_td2">
							<textarea name="content" id="content" class="one_tarea"><%=content %></textarea>
						</td>
					</tr>					
				</table>
				<div class="one_div1">
					<button type="button" class="n_btn03" id="btn_submit">수정하기</button>
